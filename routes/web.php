...
Route::get('/posts/myPage', 'myPostsController@myPage');
Route::patch('/posts/{post}', 'myPostsController@update');
Route::delete('/posts/{post}', 'myPostsController@destroy');
Route::post('/posts/{post}/commnet2s', 'CommentsController@store');
Route::delete('/posts/{post}/comment2s/{comment}', 'CommentsController@destroy');
